...
public class QTHistory extends RelationalPathBase<THistory> {
    ...
    public void addMetadata() {
        ...
        addMetadata(hisContent, ColumnMetadata.named("HIS_CONTENT").withIndex(3).ofType(Types.LONGVARCHAR).withSize(65535));
        ...
        addMetadata(originId, ColumnMetadata.named("ORIGIN_ID").withIndex(6).ofType(Types.VARCHAR).withSize(32));
        addMetadata(recordId, ColumnMetadata.named("RECORD_ID").withIndex(7).ofType(Types.VARCHAR).withSize(32));
    }
