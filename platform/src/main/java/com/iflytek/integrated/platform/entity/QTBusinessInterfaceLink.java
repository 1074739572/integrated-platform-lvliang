 ...
 */
public class QTBusinessInterfaceLink extends com.querydsl.sql.RelationalPathBase<TBusinessInterface> {

    private static final long serialVersionUID = 417267301;

    public static final QTBusinessInterfaceLink qTBusinessInterface = new QTBusinessInterfaceLink("t_business_interface");
    ...
    public QTBusinessInterfaceLink(String variable) {
        super(TBusinessInterface.class, forVariable(variable), "null", "t_business_interface");
        addMetadata();
    }

    public QTBusinessInterfaceLink(String variable, String schema, String table) {
        super(TBusinessInterface.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QTBusinessInterfaceLink(String variable, String schema) {
        super(TBusinessInterface.class, forVariable(variable), schema, "t_business_interface");
        addMetadata();
    }

    public QTBusinessInterfaceLink(Path<? extends TBusinessInterface> path) {
        super(path.getType(), path.getMetadata(), "null", "t_business_interface");
        addMetadata();
    }

    public QTBusinessInterfaceLink(PathMetadata metadata) {
