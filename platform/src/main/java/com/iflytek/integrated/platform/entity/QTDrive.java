...
public class QTDrive extends com.querydsl.sql.RelationalPathBase<TDrive> {
    ...
    public void addMetadata() {
        ...
        addMetadata(driveCode, ColumnMetadata.named("DRIVE_CODE").withIndex(3).ofType(Types.VARCHAR).withSize(32));
        addMetadata(driveContent, ColumnMetadata.named("DRIVE_CONTENT").withIndex(5).ofType(Types.LONGVARCHAR).withSize(65535));
        addMetadata(driveInstruction, ColumnMetadata.named("DRIVE_INSTRUCTION").withIndex(4).ofType(Types.VARCHAR).withSize(255));
        addMetadata(driveName, ColumnMetadata.named("DRIVE_NAME").withIndex(2).ofType(Types.VARCHAR).withSize(32));
