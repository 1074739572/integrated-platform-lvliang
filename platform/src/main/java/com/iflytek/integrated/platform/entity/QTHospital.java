...
//    public final StringPath hospitalCode = createString("hospitalCode");
    ...
    public void addMetadata() {
        addMetadata(areaId, ColumnMetadata.named("AREA_ID").withIndex(4).ofType(Types.VARCHAR).withSize(32));
...
//        addMetadata(hospitalCode, ColumnMetadata.named("HOSPITAL_CODE").withIndex(3).ofType(Types.VARCHAR).withSize(32));
        ...
        addMetadata(status, ColumnMetadata.named("STATUS").withIndex(3).ofType(Types.VARCHAR).withSize(1));
